        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Add New Team </li>
                    ...
                    <div class="card card-body">
                        <form method="POST" action="{{ route('admin.teams.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <textarea name="location" class="form-control @error('location') is-invalid @enderror" id="location" rows="2" placeholder="Enter location"></textarea>
                                @error('location')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <input type="file" placeholder="Enter Image" id="image_url"
                                    class="dropify form-control @error('image_url') is-invalid @enderror" name="image_url" data-default-file="{{ asset('backend/images/placeholder/image_placeholder.png') }}">
                                @error('image_url')
