...
@section('title', 'Edit Quizzes Category')
        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Quizzes Category Edit </li>
            ...
            <div class="col-lg-12">
                <div class="card-style mb-4">
                    <div class="card card-body">
                        <form method="POST" action="{{ route('admin.quizze_categories.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="input-style-1 col-lg-6 mt-4">
                                    ...
                                    <textarea id="sub_description" name="sub_description" rows="8"
                                        ...
                                        {{ $data->sub_description ?? old('sub_description') }}
                                    </textarea>
                                ...
                                <div class="input-style-1 col-lg-6 mt-4">
                                    ...
                                    <input type="file" placeholder="Enter Image" id="image"
                                        class="dropify form-control @error('icon') is-invalid @enderror" name="icon" data-default-file="{{ asset( $data->icon ?? 'backend/images/placeholder/image_placeholder1.png') }}">
                                    @error('icon')
