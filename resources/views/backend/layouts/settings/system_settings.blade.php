                        ...
                        <form method="POST" action="{{ route('system.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="input-style-1">
                                        ...
                                        <input type="text" placeholder="Enter Support Phone" id="support_phone"
                                            class="form-control @error('support_phone') is-invalid @enderror" name="support_phone"
                            ...
                            <div class="mt-4">
                                <div class="input-style-1">
                                    ...
                                    <textarea name="address" placeholder="Enter Address" class="form-control @error('address') is-invalid @enderror" id="address" cols="30" rows="3">{{ $setting->address ?? '' }}</textarea></textarea>
                                    @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
