                        ...
                        <form method="POST" action="{{ route('admin.blogs.update', $blog->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <input type="file" placeholder="Enter Image" id="image"
                                    class="dropify form-control @error('image') is-invalid @enderror" name="image" data-default-file="{{ asset($blog->image ?? 'backend/images/placeholder/image_placeholder.png') }}">
                                @error('image')
