        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> Education </li>
            ...
            <div class="col-lg-12">
                <div class="card p-5">
                    <div class="card-style mb-30">
                        <form method="POST" action="{{ route('cms.home.education.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="input-style-1 mt-4">
                                <label for="title">Title:</label>
                                <input type="text" placeholder="Enter Title" id="title"
                                    class="form-control @error('title') is-invalid @enderror" name="title"
                                    value="{{ $education->title ?? old('title') }}" />
                                @error('title')
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <textarea placeholder="Type here..." id="description" name="description"
                                    class="form-control @error('description') is-invalid @enderror">
                                        {{ $education->description ?? old('description') }}
                                    </textarea>
                                @error(' description ')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <input type="file" placeholder="Enter Image" id="image_url"
                                    ...
                                    data-default-file="{{ asset($education->image_url ?? 'backend/images/placeholder/image_placeholder1.png') }}">
                                @error('image_url')
