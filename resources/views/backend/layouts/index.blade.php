            ...
            <div class="row">
                <div class="col-12 col-md-4 col-lg-3 mt-4">
                    <div class="card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                <h1 class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ $totalClient }}</h1>
                                <h4 class="fs-4 fw-semibold text-gray-400 mt-5">Total Client</h4>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    ...
                                    <g>
                                        <path
                                            ...
                                            style="" fill="#3B82F6" data-original="#3B82F6"></path>
                ...
                <div class="col-12 col-md-4 col-lg-3 mt-4">
                    <div class="card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                <h1 class="fs-2hx fw-bold text-gray-800 me-2 lh-1">{{ $totalDoctor }}</h1>
                                <h4 class="fs-4 fw-semibold text-gray-400 mt-5">Total Doctor</h4>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0" y="0"
